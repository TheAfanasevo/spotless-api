...
SO DON'T THE OBJECT AND THE EXPECTED ONE! */
    ...
    it('should return 404 if invalid id is passed', async () => {
      const res = await request(server).get('/api/genres/1'); //we just give a random id to check validation
...
according to our test description */
    ...
    it('should return 400 (bad request) if genre is less than five characters', async () => {
      name = '1234';
    ...
    it('should return 400 (bad request) if genre is more than fifty characters', async () => {
      name = new Array(52).join('x'); /* We create a 51-character name */
...
//TODO: re-check tests for PUT and DELETE 'should return 404 if id is invalid'